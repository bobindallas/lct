<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a class="underline hover:text-blue-700" href="{{ route('recipe.index') }}" title="Back Recipe Index">{{ __('Recipes') }}</a> >> New
        </h2>
    </x-slot>
...
<br />
    ...
    <div class="flex items-center mr-4">
        <input id="inline-checkbox" name="ingredients[]" type="checkbox" value="{{ $ingredient->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<br />
	...
	@foreach($tags as $tag)
    <div class="flex items-center mr-4">
        <input id="inline-checkbox" name="tags[]" type="checkbox" value="{{ $tag->id }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
